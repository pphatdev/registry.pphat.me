                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="relative border-l border-border ml-4 md:ml-6 pl-8 md:pl-12 py-4 space-y-16">
                        ...
                        <div className="relative">
                            <div className="absolute -left-[41px] md:-left-[57px] top-1 w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-sm shadow-[0_0_10px_rgba(var(--primary),0.5)]">
                                1
                            </div>
                        ...
                        {/* Step 2 */}
                        <div className="relative">
                            <div className="absolute -left-[41px] md:-left-[57px] top-1 w-8 h-8 rounded-full bg-muted border border-border text-foreground flex items-center justify-center font-bold text-sm">
                                2
                            </div>
