                ...
                <div className="flex flex-col items-center group">
                    <div className="flex flex-col sm:flex-row gap-8 sm:gap-6 items-center">
                        {/* <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="relative flex items-center gap-3 p-1.5 pr-5 rounded-none bg-background/50 border border-border/60 hover:bg-background/80 hover:border-primary/40 transition-all duration-300 backdrop-blur-xl shadow-xs"
                        >
                            <p className="text-xs text-muted-foreground absolute -top-5 left-4 font-medium">Verified</p>
                            <div className="w-10 h-10 rounded-none flex items-center justify-center bg-primary/10 text-primary">
                        ...
                        >
                            ...
                            <img
                                ...
                                className="w-10 h-10 rounded-none object-cover grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-500"
                            />
                            <div className="flex flex-col text-left">
